...
let movieDirectors = watchList.filter(director => director.Director === "Christopher Nolan")
    console.log(movieDirectors)
let sumRating = movieDirectors.reduce((avg, directors) => avg + Number(directors.imdbRating), 0)
    console.log(sumRating)
   
let averageRating = (sumRating / movieDirectors.length)
